...
import 'package:arne_news/category (1).dart';
...
class _HomeState extends State<Home> {
  ...
  getNewsByQuery(String query) async {
    ...
    int i = 0;
    String url =
        "https://newsapi.org/v2/everything?q=$query&from=2023-04-19&sortBy=publishedAt&apiKey=f8717a817bc246999d87230ae1dc3e33";
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=f8717a817bc246999d87230ae1dc3e33";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
